...
class RecruitmentModal(ui.Modal):
    ...
    q3 = ui.TextInput(label='3. Wyjaśnij czym jest RP / Twoja reakcja na Wila ', placeholder='Wyjaśnij czym jes RP? / Co byś zrobił?', style=discord.TextStyle.paragraph, required=True)
    ...
    q5 = ui.TextInput(label='5. Link do filmu który pokazuje twoje mikro', placeholder='Link do filmu z mikrofonem i povem z mc ', style=discord.TextStyle.paragraph, required=True)
